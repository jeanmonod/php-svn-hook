...
$t->is($c->renderErrorSummary(), "Invalid", "A valid summary message is return");
$t->is($c->renderErrorDetail(), "Minimun size is 5 characters", "A valid detail message is return");
